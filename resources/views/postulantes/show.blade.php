    ...
    <div class="info_modal">
        <div class="h-100"> 
            <div class="title">
                <h5>Ver | Registros</h5>
                <div class='btns_gen'>
                    <div class="back"><a href="{{ route('postulantes') }}"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a></div>
                ...
                <div class="col-md-4 content_1">
                    <div class='content_section1'>
                        <div>
                            ...
                            <input type="text" disabled value="{{$postulantes->created_at->format('d/m/Y')}}">
                        </div>
                        <div>
                            <label for="">Nombre:</label>
                            <input class='name_sol' type="text" disabled value="{{$postulantes->nombre_completos}}">
                        </div>
                        <div>
                            <label for="">Años Experiencia:</label>
                            <input class='name_sol' type="text" disabled value="{{$postulantes->years_experiencia}}">
                        </div>
                    </div>
                    <div class="content_section2">
                        <div>
                            <label for="">Cargo:</label>
                            <input type="text" disabled value="{{$postulantes->cargos->nombre}}">
                        </div>
                        {{-- <div>
                            <label for="">Descripción:</label>
                            <input type="text" size="40" maxlength="80"   disabled value="{{$postulantes->cargos->descripcion}}">
                        </div> --}}
                        <div>
                            <label for="">País:</label>
                            <input type="text" disabled value="{{$postulantes->pais->pnombre}}">
                        </div>
                        <div>
                            <label for="">Ciudad:</label>
                            <input type="text" disabled value="{{$postulantes->ciudad}}">
                        </div>
                        <div>
                            <label for="">Dirección:</label>
                            <input type="text" disabled value="{{$postulantes->direccion}}">
                        </div>
                        <div>
                            <label for="">Otros Estudios:</label>
                            <input type="text" disabled value="{{$postulantes->otros_estudios}}">
                        </div>
                        <div>
